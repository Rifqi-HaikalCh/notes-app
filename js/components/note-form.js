...
class NoteForm extends HTMLElement {
    ...
    render() {
        this.innerHTML = `
            ...
            <div class="form-container">
                <h2 class="form-title">✍️ Buat Catatan Baru</h2>
                <form class="note-form">
                    <div class="form-group">
                        <label class="form-label" for="title-input">Judul Catatan</label>
                        <input type="text" id="title-input" class="form-input" placeholder="Masukkan judul catatan..." required>
                        <div class="char-counter normal">Sisa karakter: ${this.maxTitleLength}</div>
                        <div class="validation-message" id="title-validation"></div>
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label" for="body-input">Isi Catatan</label>
                        <textarea id="body-input" class="form-textarea" placeholder="Tulis catatan Anda di sini..." required></textarea>
    ...
    updateCharCounter() {
        ...
        if (remaining < 0) {
            this.titleInput.value = this.titleInput.value.substring(0, this.maxTitleLength);
            this.charCounter.textContent = 'Sisa karakter: 0';
        }
    }
